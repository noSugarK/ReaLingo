...
const zh = {
  ...
  device: "设备",
  noDevice: "未找到设备",
  loopbackLinux: "Linux 下 ALSA 没有回录通道：先选一个输入设备，再在 pavucontrol 的「录制」标签把 ReaLingo 的来源改成输出设备的 Monitor",
...
const en: typeof zh = {
  ...
  loopbackLinux: "ALSA has no loopback on Linux: pick an input device, then point ReaLingo's source at your output's Monitor in pavucontrol’s Recording tab",
