...
const zh = {
  ...
  history: "翻译历史",
  historyRec: "记录",
  historyHint: "记录翻译历史：每次翻译存成一个文件，可在历史里翻看。默认不记录。",
  historyDir: "打开文件夹",
  historyClear: "清空全部",
  historyNone: "还没有历史记录",
  historyOff: "历史记录未开启",
...
const en: typeof zh = {
  ...
  history: "History",
  historyRec: "Record",
  historyHint: "Save this run to a file you can browse later. Off by default.",
  historyDir: "Open folder",
  historyClear: "Clear all",
  historyNone: "Nothing saved yet",
  historyOff: "History is off",
  historyGo: "Turn it on",
  historyPick: "Pick a session on the left",
  historySearch: "Search this session…",
  historyUnit: "lines",
  historyDel: "Delete",
  historyConfirm: "Sure?",
  historyFailed: "Could not write history; this session will not be saved:",
